...
#                                     <input type="hidden" name="username" id="textUsername">
#                                     <div class="mb-4">
#                                         <input 
#                                             type="text" 
#                                             name="user_query" 
...
#                                     <input type="hidden" name="username" id="imageUsername">
#                                     <div class="mb-4">
...
#                                     <input type="hidden" name="username" id="voiceUsername">
#                                     <div class="mb-4">
#                                         <label class="block w-full">
#                                             <input 
#                                                 type="file" 
...
#                 // Set usernames in all forms
#                 document.getElementById('textUsername').value = username;
#                 document.getElementById('imageUsername').value = username;
#                 document.getElementById('voiceUsername').value = username;
...
#                 response.raise_for_status()
#                 api_response = response.json()
#                 return jsonify({'cart': api_response.get('cart', [])})
#         except requests.RequestException as e:
#             return jsonify({'error': f'API error: {str(e)}'}), 500
#         finally:
#             os.remove(file_path)
